...
public class ProgressHandler : MonoBehaviour
{
    ...
    public void MilestoneStatus()
    {
        ...
        {
            panelRectTransform.sizeDelta = new Vector2(800, 50);
        }
        else if (robot.bots >= 500 && robot.bots <= 999)
        {
            panelRectTransform.sizeDelta = new Vector2(800, 100);
        }
        else if (robot.bots >= 1000 && robot.bots <= 4999)
        {
            panelRectTransform.sizeDelta = new Vector2(800, 150);
        }
        else if (robot.bots >= 5000 && robot.bots <= 9999)
        {
            panelRectTransform.sizeDelta = new Vector2(800, 200);
        }
        else if (robot.bots >= 10000 && robot.bots <= 49999)
        {
            panelRectTransform.sizeDelta = new Vector2(800, 250);
        }
        else if (robot.bots >= 50000 && robot.bots <= 99999)
        {
            panelRectTransform.sizeDelta = new Vector2(800, 300);
        }
